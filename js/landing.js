...
$( document ).ready(function() {
    ...
    $('.mn-toggle').click(function(){
        if (!$(this).hasClass('has-active-slider')) {
            $('#mobile-nav').addClass('is-active');
            $('#page-mask').addClass('has-active-slider');
            $('.page-wrapper').addClass('has-active-slider');
            $('.mn-toggle').addClass('has-active-slider');
        }
    });
    $('.mn-close').click(function(){
        $('#mobile-nav').removeClass('is-active');
        $('#page-mask').removeClass('has-active-slider');
        $('.page-wrapper').removeClass('has-active-slider');
        $('.mn-toggle').removeClass('has-active-slider');
    });
